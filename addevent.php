...
if (!$error) 
{
    ...
    {        
        ...
        {
            $sdatetime = strtotime($_POST['sdate']) + $_POST['stime']['Hour']*60*60 + $_POST['stime']['Minute']*60 - getuseroffset($check['uname']);
            $edatetime = strtotime($_POST['edate']) + $_POST['etime']['Hour']*60*60 + $_POST['etime']['Minute']*60 - getuseroffset($check['uname']);
